            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Connexy - Your Gateway to Amplifying Your Commerce Reach
                    </h1>
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Unleash your potential by crafting a captivating online presence that resonates with your target audience. 
                        Reach your ideal customers with precision using advanced search filters, 
                        and foster meaningful interactions that convert into loyal patrons. 
                        Gain valuable insights through our comprehensive analytics dashboard and 
                        immerse yourself in a thriving community of merchants. Join the path to remarkable success with Connexy, 
                        your comprehensive platform for digital transformation.
                    </p>
