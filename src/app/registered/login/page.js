                ...
                <div className="py-6 px-8 h-80 mt-20 bg-white rounded shadow-xl">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <Link href="/registered/signup" className="text-sm font-thin text-gray-800 hover:underline mt-2 mr-3 inline-block hover:text-indigo-600">Don't have an account?</Link>
                            <Link href="/admin/login" className="text-sm font-thin text-gray-800 hover:underline mt-2 inline-block hover:text-indigo-600">Login as administrator</Link>
                        </div>
