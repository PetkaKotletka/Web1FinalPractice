            ...
            <div className="h-screen bg-gray-100 flex justify-center">
                <div className="py-6 px-8 mt-20 bg-white rounded shadow-xl">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-6">
                            <label htmlFor="name" className="block text-gray-800 font-bold">Full name:</label>
                        ...
                        <div className="mb-6">
                            <label htmlFor="age" className="block text-gray-800 font-bold">Age:</label>
                        ...
                        <div>
                            ...
                            <Link href="/registered/login" className="text-sm font-thin text-gray-800 hover:underline mt-2 mr-3 inline-block hover:text-indigo-600">Already have an account?</Link>
                        </div>
